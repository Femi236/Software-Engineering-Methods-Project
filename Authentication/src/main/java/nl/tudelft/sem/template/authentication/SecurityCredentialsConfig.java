...
public class SecurityCredentialsConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .addFilterAfter(new JwtTokenAuthenticationFilter(jwtConfigure),
                ...
                .addFilter(new JwtUsernameAndPasswordAuthenticationFilter(
                        authenticationManager(), jwtConfigure))
                .authorizeRequests()
                // allow all POST requests
                .antMatchers(HttpMethod.POST, jwtConfigure.getUri()).permitAll()
    ...
    // provide our implementation for fetching user from database (or any other source).
